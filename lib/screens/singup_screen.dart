...
class _SingUpScreenState extends State<SingUpScreen> {
  ...
  void _onSuccess(){
    _scaffoldKey.currentState.showSnackBar(SnackBar(content: Text("Usuário cadastrado com sucesso!"),
  ...
  void _onFail(){
    _scaffoldKey.currentState.showSnackBar(SnackBar(content: Text("Falha em cadastrar o usuario!"),
